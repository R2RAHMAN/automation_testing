...
public class MainPage extends Form {
    ...
    private final IButton firstChild = getElementFactory().getButton(By.xpath("/html/body/div/div[1]/div[3]/div/div[1]/div[2]/div[2]/div[1]"), "First Child");
    private final ITextBox txtSearch = getElementFactory().getTextBox(By.className("search-input"), "Search Input");
    ...
    public boolean isSuggestionsDisplayed() {
        return elements.stream()
                .allMatch(button -> button.state().isDisplayed());
    }
